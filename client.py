...
def main():
    parser = argparse.ArgumentParser(description="Non-interactive strategy client for Alice/Charles game (localhost only)")
    parser.add_argument("port", type=int, help="Port")
    parser.add_argument("name", type=str, help="Your display name")
    parser.add_argument("role", type=str, choices=["Arranger", "Chooser"], help="Your role")
